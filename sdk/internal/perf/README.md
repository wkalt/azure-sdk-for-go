...
Navigate to your SDK performance test, for example `sdk/security/keyvault/azkeys/testdata/perf`, and run `go mod download` to download all the requirements for the performance framework.
